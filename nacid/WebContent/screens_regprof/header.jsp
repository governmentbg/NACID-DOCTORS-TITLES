...
var higherProfessionalQualificationNomenclatureId = <%= NomenclaturesDataProvider.FLAT_NOMENCLATURE_HIGHER_PROF_QUALIFICATION%>;
var higherSpecialityNomenclatureId = <%= NomenclaturesDataProvider.FLAT_NOMENCLATURE_HIGHER_SPECIALITY%>;
var secondarySpecialityNomenclatureId = <%= NomenclaturesDataProvider.NOMENCLATURE_SECONDARY_SPECIALITY%>;
var secondaryProfessionalQualificationNomenclatureId = <%= NomenclaturesDataProvider.NOMENCLATURE_SECONDARY_PROFESSIONAL_QUALIFICATION%>;
var professionId = <%= NomenclaturesDataProvider.FLAT_NOMENCLATURE_PROFESSION%>;
var professionExperienceId = <%=NomenclaturesDataProvider.FLAT_NOMENCLATURE_PROFESSION_EXPERIENCE %>; 
