...
<validation:form action="${pathPrefix }/control/nom_regprofappstatus/save" method="post" name="countryForm"
                 backurl="${pathPrefix }/control/nom_regprofappstatus/list?getLastTableState=1">
