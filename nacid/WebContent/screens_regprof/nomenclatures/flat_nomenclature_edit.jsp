...
<nacid:flatNomenclature>
	...
	<validation:form action="${pathPrefix }/control/${url }/save" method="post" name="flatNomenclatureForm" backurl="${pathPrefix }/control/${url }/list?getLastTableState=1">
		...
		<validation:textValidator input="name" minLength="1" maxLength="${nomenclatureNameLength }" required="true" regex="${validations.nomenclature_name_with_fullstop_digits}" errormessage="${messages.err_nomenclature_name_with_fullstop_digits}" />
	</validation:form>
</nacid:flatNomenclature>
