...
<v:form action="${pathPrefix }/control/person/save" method="post" name="form_person" backurl="${pathPrefix }/control/person/list?getLastTableState=1">
	...
	<nacid:applicationPersonEdit person="applicant">
		...
		</span> <v:textinput class="brd w200" maxlength="255" name="applicant_personal_id" id="applicant_personal_id"  value="${person_civil_id }" /></p>
		<div class="clr"><!--  --></div>
		<v:egnLnchValidator input="applicant_personal_id" required="true"/> <script type="text/javascript">
	...
	initPersonalIdIgnoreValidation();
		...
		</span> <v:textinput class="brd w500" maxlength="100" name="applicant_first_name" id="applicant_first_name"  value="${person_first_name }" /></p>
		<div class="clr"><!--  --></div>
		<p><span class="fieldlabel"><label for="applicant_middle_name">Презиме</label><br />
		</span> <v:textinput class="brd w500" maxlength="100" name="applicant_middle_name" id="applicant_middle_name"  value="${person_middle_name }" /></p>
		<div class="clr"><!--  --></div>
		<p><span class="fieldlabel"><label for="applicant_last_name">Фамилия</label><br />
		</span> <v:textinput class="brd w500" maxlength="100" name="applicant_last_name" id="applicant_last_name"  value="${person_last_name }" /></p>
		<div class="clr"><!--  --></div>
		...
		</span> <v:textinput class="brd w500" maxlength="100" name="applicant_birth_place_location" id="applicant_birth_place_location" 
