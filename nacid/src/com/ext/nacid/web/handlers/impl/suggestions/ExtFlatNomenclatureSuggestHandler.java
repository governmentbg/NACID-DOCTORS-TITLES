...
public class ExtFlatNomenclatureSuggestHandler extends NacidExtBaseRequestHandler{

	public ExtFlatNomenclatureSuggestHandler(ServletContext servletContext) {
	...
	public void processRequest(HttpServletRequest request, HttpServletResponse response) {
		...
		List<FlatNomenclature> nomenclatures = nomenclaturesDataProvider.getFlatNomenclatures(type, partOfName, onlyActive ? new Date() : null, null);
		try {
