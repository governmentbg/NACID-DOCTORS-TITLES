...
public class ExtApplicationRecognitionPurposeEditTag extends SimpleTagSupport {
  private boolean input;
  private ExtTrainingCourseWebModel webmodel;
  public void setInput(boolean input) {
    this.input = input;
  }
  public void doTag() throws JspException, IOException {
    webmodel = (ExtTrainingCourseWebModel) getJspContext().getAttribute(WebKeys.EXT_TRAINING_COURSE_WEB_MODEL, PageContext.REQUEST_SCOPE);
    if (webmodel == null) {
      return;
    }
    if (!input) {
