...
public class RegprofApplicationAttachmentRecord {
    ...
    public RegprofApplicationAttachmentRecord() {
    }

    public RegprofApplicationAttachmentRecord(int id, int parentId, String docDescr, Integer docTypeId, String contentType, String fileName, InputStream contentStream, Integer copyTypeId, String docflowId, Date docflowDate, String scannedContentType, String scannedFileName, InputStream scannedContentStream) {
        this.id = id;
    ...
    /*public RegprofApplicationAttachmentRecord(int id, int parentId, String docDescr, Integer docTypeId, String contentType, String fileName, InputStream contentStream, Integer copyTypeId,
                    String docflowId, Date docflowDate, String scannnedContentType, String scannedFileName, InputStream scannedContentStream) {
