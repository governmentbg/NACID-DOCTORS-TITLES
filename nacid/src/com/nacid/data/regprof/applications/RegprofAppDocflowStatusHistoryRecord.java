...
@Table(name="regprof.app_status_docflow_history", sequence = "regprof.app_status_docflow_history_id_seq")
public class RegprofAppDocflowStatusHistoryRecord {
    ...
    public RegprofAppDocflowStatusHistoryRecord(){

    }

    public RegprofAppDocflowStatusHistoryRecord(int id, int applicationId, int appStatusDocflowId, Date dateAssigned, int userAssigned) {
        this.id = id;
