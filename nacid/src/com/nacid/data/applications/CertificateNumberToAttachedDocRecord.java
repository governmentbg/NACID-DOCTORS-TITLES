...
public class CertificateNumberToAttachedDocRecord {
	private int id;
	...
	public CertificateNumberToAttachedDocRecord() {
	}
	public CertificateNumberToAttachedDocRecord(int id, String certificateNumber, Integer attachedDocId, int applicationId, int invalidated, UUID uuid) {
		this.id = id;
