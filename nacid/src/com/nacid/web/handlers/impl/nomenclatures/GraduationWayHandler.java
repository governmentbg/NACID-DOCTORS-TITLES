...
public class GraduationWayHandler extends FlatNomenclatureHandler {
    public GraduationWayHandler(ServletContext servletContext) {
        super(servletContext, "graduation_way_edit");
    }
    ...
    public void handleEdit(HttpServletRequest request, HttpServletResponse response) {
        ...
        List<Integer> applicationTypesPerGraduationWay = getNacidDataProvider().getNomenclaturesDataProvider().getApplicationTypesPerGraduationWay(flatNomenclatureId);
    ...
    public void handleSave(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (systemMessage == null || systemMessage.getMessageType() == SystemMessageWebModel.MESSAGE_TYPE_CORRECT) {
            getNacidDataProvider().getNomenclaturesDataProvider().updateGraduationWayApplicationTypes(flatNomenclatureId, appTypeIds);
        }
