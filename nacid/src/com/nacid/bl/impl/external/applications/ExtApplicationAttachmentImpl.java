...
public class ExtApplicationAttachmentImpl implements Attachment {
	...
	ExtApplicationAttachmentImpl(ExtApplicationAttachmentRecord rec, NacidDataProvider nacidDataProvider) {
