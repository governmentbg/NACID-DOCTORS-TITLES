package com.nacid.configuration.security.regprof.internal;
...
@Configuration
@Order(10)
public class RegprofInternalApplicationSecurityConfiguration extends BaseApplicationSecurityConfiguration {
    @Override
