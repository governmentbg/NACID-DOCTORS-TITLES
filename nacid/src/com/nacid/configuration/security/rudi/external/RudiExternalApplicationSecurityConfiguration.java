package com.nacid.configuration.security.rudi.external;
...
@Configuration
@Order(10)
public class RudiExternalApplicationSecurityConfiguration extends BaseApplicationSecurityConfiguration {
    @Override
